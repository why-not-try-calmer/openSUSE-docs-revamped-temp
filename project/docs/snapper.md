...
!!! note
    The last ten important and the last ten regular snapshot pairs are kept. This total encompasses both the _Installation_ and _Administration_ snapshot types.
