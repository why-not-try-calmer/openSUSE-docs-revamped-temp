...
15. The Art of Reporting bugs
    * the openSUSE bugzilla
    * the KDE bugilla
    * GitHub & GitLab Issues
### Resources
16. Other sources of documentation
    * Reference documentation
    * Wiki
### Contribute to this docs
17. A contributor's checklist
    * get in touch
    * open an issue
    * make a pull request
    * Doc Team onboarding
